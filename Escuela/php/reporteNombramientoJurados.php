<?php
    ...
    if(count($mongo->getProjectsFormatAAnualAndSemestral())>0){
        if(count($mongo->getProjectsFormatFAnualAndSemestral())>0){
            $projectsA = $mongo->getProjectsFormatAAnualAndSemestral();
            $projectsF = $mongo->getProjectsFormatFAnualAndSemestral();
        }
    }
