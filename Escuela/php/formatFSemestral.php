...
<form action="../php/aprobar.php" method="post">
    ...
    <label for="id_register_estudiante">Nro de Registro: <input type="text" name="id_register_estudiante" id="id_register_estudiante" class="form-control" value="<?php echo $element->id_register_estudiante?>" disabled></label>
